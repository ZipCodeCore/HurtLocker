...
// 2. split string of all symbols  ***
// 3. sort list of strings to keyList & valueList  ***
// 4. createItems method for inside of itemParser   ***
// 5. create itemParser that throws exception for null key or values ***
// 6. create priceTally method to tally up all 4 types lists of items ***
// 7. create formatToPrint method that formats and prints all info
//
