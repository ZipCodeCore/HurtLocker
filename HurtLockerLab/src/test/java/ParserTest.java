...
/**
 * Created by latashawatson on 2/10/17.
 */
...
//        int expected = 112;
//        parser.split(input);
//        int actual = parser.fieldHeaders.size();
...
//       int expected = 28;
//       parser.createItem();
//       int result = parser.milkItem.size() + parser.breadItem.size() + parser.applesItem.size() + parser.cookiesItem.size() + parser.numberOfErrors;
//       int actual = result;
//       Assert.assertEquals("values should be equal", expected, actual);
//    }
//
//    @Test
//    public void priceTallyTest(){
//        int expected = 1;
//        parser.priceTally(parser.milkItem);
//        int actual = parser.milkPrice1Tally;
//        Assert.assertEquals("Values should be equal", expected, actual);
//    }
//}
